...
| **2** | **Selection Sort** <br> Estudo do algoritmo de ordenação por seleção, que busca repetidamente o menor elemento e o posiciona corretamente. | - Compreender o funcionamento do Selection Sort.<br>- Implementar o algoritmo.<br>- Analisar sua complexidade de tempo O(n²). | Aula <br> Exercícios |
| **3** | **Insertion Sort** <br> Análise do algoritmo de ordenação por inserção, eficiente para conjuntos de dados pequenos ou parcialmente ordenados. | - Implementar o Insertion Sort.<br>- Comparar seu desempenho com o Selection Sort.<br>- Entender seus casos de uso ideais. | Aula <br> Exercícios |
| **4** | **Bubble Sort** <br> Estudo do Bubble Sort, um algoritmo simples que compara pares adjacentes e os troca de lugar se estiverem na ordem errada. | - Implementar a lógica do Bubble Sort.<br>- Analisar sua complexidade e ineficiência em grandes volumes de dados.<br>- Discutir otimizações como o "short-circuit". | Aula <br> Exercícios |
...
| **6** | **Quick Sort** <br> Estudo do Quick Sort, outro algoritmo de "dividir para conquistar" que se destaca pela sua velocidade na prática. | - Compreender a estratégia de particionamento e a escolha do pivô.<br>- Implementar o Quick Sort.<br>- Analisar seu desempenho no caso médio e pior caso. | Aula <br> Exercícios |
...
| **13** | **Listas Circulares** <br> Estudo de listas onde o último nó aponta para o primeiro, criando um ciclo. Útil em buffers e escalonamento. | - Implementar listas circulares (simples e duplas).<br>- Compreender cenários de aplicação como o algoritmo Round-Robin. | Aula <br> Exercícios |
