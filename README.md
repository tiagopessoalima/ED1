...
| **3** | **Insertion Sort** <br> Análise do algoritmo de ordenação por inserção, eficiente para conjuntos de dados pequenos ou parcialmente ordenados. | - Implementar o Insertion Sort.<br>- Comparar seu desempenho com o Selection Sort.<br>- Entender seus casos de uso ideais. | [Aula](Semana_03_(ED1).ipynb) <br> Exercícios |
| **4** | **Selection Sort** <br> Algoritmo que busca repetidamente o menor elemento e o posiciona corretamente. | - Compreender o funcionamento do Selection Sort.<br>- Implementar o algoritmo.<br>- Analisar sua complexidade de tempo O(n²). | [Aula](Semana_02_(ED1).ipynb)  <br> Exercícios |
