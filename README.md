...
| **2** | **Bubble Sort** <br> Algoritmo simples que compara pares adjacentes e os troca de lugar se estiverem na ordem errada. | - Definir o que são algoritmos de ordenação; <br> - Explicar o funcionamento e a complexidade do *Bubble Sort*; <br> - Conhecer as métricas para avaliar algoritmos (tempo, espaço e estabilidade). | [Aula](Semana_02_(ED1).ipynb) <br> Exercícios |
