...
| **3** | **Insertion Sort** <br> Análise do algoritmo de ordenação por inserção, eficiente para conjuntos de dados pequenos ou parcialmente ordenados. | - Explicar o *Insertion Sort*; <br> - Analisar sua complexidade (O(n²) e O(n)); <br> - Listar suas vantagens e desvantagens. | [Aula](Semana_03_(ED1).ipynb) <br> Exercícios |
...
| **5** | **Prova 1** <br> Prova teórica e prática sobre os conteúdos das semanas 1 a 4. | - Avaliar o domínio dos conceitos de complexidade e a implementação de algoritmos de ordenação simples. | [Pré-Teste](Pre-Teste_01_(ED1).pdf) |
...
| **8** | **Prova 2** <br> Prova teórica e prática sobre os conteúdos das semanas 6 e 7. | - Avaliar o domínio dos conceitos de complexidade e a implementação de algoritmos de ordenação eficientes. | [Pré-Teste]() |
...
| **10** | **Projeto 1** <br> Desenvolvimento de um projeto prático para aplicar e comparar o desempenho dos algoritmos de ordenação estudados. | - Comparar métodos de extração de características; <br> - Medir tempo e custo computacional de ordenação; <br> - Avaliar a qualidade da ordenação. | [Orientações](Semana_10_(ED1).pdf) |
...
| **14** | **Prova 3** <br> Prova teórica e prática sobre os conteúdos das semanas 11 a 13. | - Avaliar o domínio das estruturas de dados listas encadeadas (simples, dupla e circular). | [Pré-Teste]() |
