...
| **5** | **Prova 1** <br> Prova teórica e prática sobre os conteúdos das semanas 1 a 4. | - Avaliar o domínio dos conceitos de complexidade e a implementação de algoritmos de ordenação simples. | [Pré-Teste 25.2](Pre-Teste_01_(ED1)_25_2.pdf) [Pré-Teste 26.2](Pre-Teste_01_(ED1)_26_2.pdf) |
