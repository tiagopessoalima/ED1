...
| **2** | **Selection Sort** <br> Estudo do algoritmo de ordenação por seleção, que busca repetidamente o menor elemento e o posiciona corretamente. | - Compreender o funcionamento do Selection Sort.<br>- Implementar o algoritmo.<br>- Analisar sua complexidade de tempo O(n²). | [Aula](Semana_02_(ED1).ipynb)  <br> Exercícios |
