...
| **5** | **Prova 1** <br> Prova teórica e prática sobre os conteúdos das semanas 1 a 4. | - Avaliar o domínio dos conceitos de complexidade e a implementação de algoritmos de ordenação simples. | [Pré-Teste]() |
